...
Bugs are tracked as issues in this [project's Github repository](https://github.com/joewalker/bzjs/issues). Use the `gh` CLI tool to create, list, and view issues from the terminal. See [`docs/bug-tracking.md`](docs/bug-tracking.md) for the S1 to S4 severity definitions we use when classifying bugs.
