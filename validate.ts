...
const typeMap: any = {
  Bug: o(
    [
      ...
      {
        json: 'cf_status_thunderbird_esr91',
        js: 'cfStatusThunderbirdEsr91',
        typ: r('CF'),
      },
      { json: 'is_creator_accessible', js: 'isCreatorAccessible', typ: true },
      {
        json: 'cf_tracking_firefox92',
        js: 'cfTrackingFirefox92',
        typ: r('CF'),
      },
      ...
      {
        json: 'cf_tracking_firefox_esr78',
        js: 'cfTrackingFirefoxEsr78',
        typ: r('CF'),
      },
      { json: 'see_also', js: 'seeAlso', typ: a('') },
      { json: 'cf_fx_iteration', js: 'cfFxIteration', typ: r('CF') },
      {
        json: 'cf_tracking_firefox_esr91',
        js: 'cfTrackingFirefoxEsr91',
        typ: r('CF'),
      },
      {
        json: 'cf_qa_whiteboard',
        js: 'cfQAWhiteboard',
        typ: r('CFQAWhiteboard'),
      },
      {
        json: 'cf_status_firefox_esr91',
        js: 'cfStatusFirefoxEsr91',
        typ: r('CFStatusEnum'),
      },
      ...
      {
        json: 'cf_tracking_firefox93',
        js: 'cfTrackingFirefox93',
        typ: r('CF'),
      },
      { json: 'duplicates', js: 'duplicates', typ: a(0) },
      {
        json: 'cf_tracking_firefox_relnote',
        js: 'cfTrackingFirefoxRelnote',
        typ: r('CF'),
      },
      { json: 'cf_root_cause', js: 'cfRootCause', typ: r('CF') },
      {
        json: 'cf_status_firefox_esr78',
        js: 'cfStatusFirefoxEsr78',
        typ: r('CFStatusEnum'),
      },
      ...
      {
        json: 'cf_status_firefox92',
        js: 'cfStatusFirefox92',
        typ: r('CFStatusEnum'),
      },
      ...
      {
        json: 'cf_status_thunderbird_esr78',
        js: 'cfStatusThunderbirdEsr78',
        typ: r('CF'),
      },
      {
        json: 'cf_a11y_review_project_flag',
        js: 'cfA11YReviewProjectFlag',
        typ: r('CF'),
      },
      { json: 'is_confirmed', js: 'isConfirmed', typ: true },
      {
        json: 'cf_tracking_firefox94',
        js: 'cfTrackingFirefox94',
        typ: r('CF'),
      },
      { json: 'is_cc_accessible', js: 'isCcAccessible', typ: true },
      {
        json: 'cf_webcompat_priority',
        js: 'cfWebcompatPriority',
        typ: r('Priority'),
      },
      ...
      {
        json: 'cf_tracking_thunderbird_esr78',
        js: 'cfTrackingThunderbirdEsr78',
        typ: r('CF'),
      },
      { json: 'flags', js: 'flags', typ: a(r('Flag')) },
      {
        json: 'cf_has_regression_range',
        js: 'cfHasRegressionRange',
        typ: r('CF'),
      },
      { json: 'creation_time', js: 'creationTime', typ: Date },
      {
        json: 'cf_tracking_firefox_sumo',
        js: 'cfTrackingFirefoxSumo',
        typ: r('CF'),
      },
      ...
      {
        json: 'cf_tracking_thunderbird_esr91',
        js: 'cfTrackingThunderbirdEsr91',
        typ: r('CF'),
      },
      ...
      {
        json: 'cf_status_firefox93',
        js: 'cfStatusFirefox93',
        typ: r('CFStatusEnum'),
      },
      {
        json: 'classification',
      ...
      { json: 'cc', js: 'cc', typ: a('') },
      {
        json: 'cf_status_firefox78',
        js: 'cfStatusFirefox78',
        typ: u(undefined, ''),
      },
      {
        json: 'cf_status_firefox_esr68',
        js: 'cfStatusFirefoxEsr68',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_status_firefox75',
        js: 'cfStatusFirefox75',
        typ: u(undefined, ''),
      },
      {
        json: 'cf_status_firefox74',
        js: 'cfStatusFirefox74',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_status_firefox73',
        js: 'cfStatusFirefox73',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_status_firefox76',
        js: 'cfStatusFirefox76',
        typ: u(undefined, ''),
      },
      {
        json: 'cf_tracking_firefox75',
        js: 'cfTrackingFirefox75',
        typ: u(undefined, ''),
      },
      {
        json: 'cf_status_firefox83',
        js: 'cfStatusFirefox83',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_status_firefox68',
        js: 'cfStatusFirefox68',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_status_firefox52',
        js: 'cfStatusFirefox52',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_status_firefox57',
        js: 'cfStatusFirefox57',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_tracking_firefox87',
        js: 'cfTrackingFirefox87',
        typ: u(undefined, ''),
      },
      {
        json: 'cf_status_firefox87',
        js: 'cfStatusFirefox87',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_status_firefox90',
        js: 'cfStatusFirefox90',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_tracking_firefox89',
        js: 'cfTrackingFirefox89',
        typ: u(undefined, ''),
      },
      {
        json: 'cf_status_firefox89',
        js: 'cfStatusFirefox89',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_status_firefox91',
        js: 'cfStatusFirefox91',
        typ: u(undefined, ''),
      },
      {
        json: 'cf_status_firefox86',
        js: 'cfStatusFirefox86',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_status_firefox85',
        js: 'cfStatusFirefox85',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_status_firefox62',
        js: 'cfStatusFirefox62',
        typ: u(undefined, r('CFStatusEnum')),
      },
      {
        json: 'cf_status_firefox63',
        js: 'cfStatusFirefox63',
        typ: u(undefined, r('CFStatusEnum')),
      },
    ],
    false
  ...
  CF: ['---', 'yes'],
  CFQAWhiteboard: ['', 'qa-not-actionable', '[qa-triaged]'],
  CFStatusEnum: ['affected', '---', 'wontfix', 'unaffected', 'fixed'],
  Priority: ['--', 'P1', 'P2', 'P3'],
  Classification: ['Components'],
  Platform: ['All', 'Desktop', 'Unspecified', 'x86_64'],
  Product: ['Core'],
  Status: ['ASSIGNED', 'REOPENED', 'RESOLVED', 'VERIFIED'],
