...
export type BugStatusEnum = 'UNCONFIRMED' | 'NEW' | 'ASSIGNED' | 'REOPENED' | 'RESOLVED' | 'VERIFIED' | 'CLOSED';

export type BugFieldEnum = 'bug_status' | 'cf_webcompat_priority';

export type MatchTypeEnum = (
  'equals' | 'notequals' | 'anyexact' | 'substring' | 'casesubstring' |
  'notsubstring' | 'anywordssubstr' | 'allwordssubstr' | 'nowordssubstr' |
  'regexp' | 'notregexp' | 'lessthan' | 'lessthaneq' | 'greaterthan' |
  'greaterthaneq' | 'anywords' | 'allwords' | 'nowords' | 'everchanged' |
  'changedbefore' | 'changedafter' | 'changedfrom' | 'changedto' | 'changedby' |
  'matches' | 'notmatches' | 'isempty' | 'isnotempty'
);
